...
UI_MENU_ACTIONSELECTOR_FILTER(ui_menu_go_xpos, UI_TEXT_X_POSITION, ui_menu_xpos, 0, MENU_MODE_PRINTING | MENU_MODE_SD_PRINTING | MENU_MODE_PAUSED)
UI_MENU_ACTIONSELECTOR_FILTER(ui_menu_go_ypos, UI_TEXT_Y_POSITION, ui_menu_ypos, 0, MENU_MODE_PRINTING | MENU_MODE_SD_PRINTING | MENU_MODE_PAUSED)
