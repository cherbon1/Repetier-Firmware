...
#define UI_MENU_POSITIONS {UI_MENU_ADDCONDBACK UI_HOME_COND UI_SPEED_COND UI_CONFIG_SINGLE_STEPS SET_TO_XY_ORIGIN_ENTRY UI_E_POSITION_COND}
UI_MENU(ui_menu_positions, UI_MENU_POSITIONS, UI_MENU_BACKCNT + UI_HOME_COUNT + UI_SPEED_COUNT + UI_CONFIG_SINGLE_STEPS_COUNT + SET_TO_XY_ORIGIN_COUNT + UI_E_POSITION_COUNT)
