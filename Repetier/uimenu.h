...
UI_MENU_ACTIONCOMMAND_FILTER(ui_menu_home_all,UI_TEXT_HOME_ALL,UI_ACTION_HOME_ALL, 0, MENU_MODE_PRINTING | MENU_MODE_PAUSED)
UI_MENU_ACTIONCOMMAND_FILTER(ui_menu_home_x,UI_TEXT_HOME_X,UI_ACTION_HOME_X, 0, MENU_MODE_PRINTING | MENU_MODE_PAUSED)
UI_MENU_ACTIONCOMMAND_FILTER(ui_menu_home_y,UI_TEXT_HOME_Y,UI_ACTION_HOME_Y, 0, MENU_MODE_PRINTING | MENU_MODE_PAUSED)
UI_MENU_ACTIONCOMMAND_FILTER(ui_menu_home_z,UI_TEXT_HOME_Z,UI_ACTION_HOME_Z, 0, MENU_MODE_PRINTING | MENU_MODE_PAUSED)
...
UI_MENU_ACTIONSELECTOR_FILTER(ui_menu_go_epos, UI_TEXT_E_POSITION, ui_menu_epos, MENU_MODE_PRINTER, MENU_MODE_PRINTING | MENU_MODE_PAUSED)
...
UI_MENU_ACTIONCOMMAND_FILTER(ui_menu_heat_bed_scan,UI_TEXT_DO_HEAT_BED_SCAN,UI_ACTION_RF_SCAN_HEAT_BED,MENU_MODE_PRINTER, MENU_MODE_PRINTING | MENU_MODE_PAUSED)
#define UI_MENU_HEAT_BED_SCAN_COUNT 1

UI_MENU_ACTIONCOMMAND_FILTER(ui_menu_heat_bed_scan_pla,UI_TEXT_HEAT_BED_SCAN_PLA,UI_ACTION_RF_SCAN_HEAT_BED_PLA,MENU_MODE_PRINTER, MENU_MODE_PRINTING | MENU_MODE_PAUSED)
UI_MENU_ACTIONCOMMAND_FILTER(ui_menu_heat_bed_scan_abs,UI_TEXT_HEAT_BED_SCAN_ABS,UI_ACTION_RF_SCAN_HEAT_BED_ABS,MENU_MODE_PRINTER, MENU_MODE_PRINTING | MENU_MODE_PAUSED)
...
UI_MENU_ACTIONCOMMAND_FILTER(ui_menu_mhier_z_scan,UI_TEXT_DO_MHIER_BED_SCAN,UI_ACTION_RF_DO_MHIER_BED_SCAN,MENU_MODE_PRINTER, MENU_MODE_PRINTING | MENU_MODE_PAUSED)
UI_MENU_ACTIONCOMMAND_FILTER(ui_menu_mhier_auto_matrix_leveling,UI_TEXT_DO_MHIER_AUTO_MATRIX_LEVELING,UI_ACTION_RF_DO_MHIER_AUTO_MATRIX_LEVELING,MENU_MODE_PRINTER,MENU_MODE_PRINTING | MENU_MODE_PAUSED)
...
UI_MENU_ACTIONCOMMAND_FILTER(ui_menu_zcomp_alignextruder, UI_TEXT_ALIGN_EXTRUDERS, UI_ACTION_ALIGN_EXTRUDERS, MENU_MODE_PRINTER, MENU_MODE_PRINTING | MENU_MODE_PAUSED)
...
#if FEATURE_HEAT_BED_Z_COMPENSATION
UI_MENU_ACTIONCOMMAND_FILTER(ui_menu_save_active_zMatrix,UI_TEXT_DO_SAVE_ACTIVE_ZMATRIX,UI_ACTION_RF_DO_SAVE_ACTIVE_ZMATRIX,MENU_MODE_PRINTER, MENU_MODE_PRINTING | MENU_MODE_PAUSED)
...
UI_MENU_ACTIONCOMMAND_FILTER(ui_menu_work_part_scan,UI_TEXT_DO_WORK_PART_SCAN,UI_ACTION_RF_SCAN_WORK_PART,0,MENU_MODE_PRINTER | MENU_MODE_PRINTING | MENU_MODE_PAUSED)
...
UI_MENU_CHANGEACTION_FILTER(ui_menu_set_z_matrix_heat_bed,UI_TEXT_SET_Z_MATRIX_HEAT_BED,UI_ACTION_RF_SET_Z_MATRIX_HEAT_BED,MENU_MODE_PRINTER, MENU_MODE_PRINTING | MENU_MODE_PAUSED)
...
#if FEATURE_WORK_PART_Z_COMPENSATION || FEATURE_HEAT_BED_Z_COMPENSATION
UI_MENU_CHANGEACTION_FILTER(ui_menu_set_z_scan_start_lift,UI_TEXT_SCAN_START_HEIGHT,UI_ACTION_RF_SCAN_START_HEIGHT, 0, MENU_MODE_PRINTING | MENU_MODE_PAUSED)
...
UI_MENU_ACTIONCOMMAND_FILTER(ui_menu_ext_origin,UI_TEXT_SET_E_ORIGIN,UI_ACTION_SET_E_ORIGIN,MENU_MODE_PRINTER, MENU_MODE_PRINTING | MENU_MODE_PAUSED )

/** \brief Extruder->Load Filament-> */
/** \brief Extruder->Unload Filament-> */

UI_MENU_ACTIONCOMMAND_FILTER(ui_menu_extruder_mount_filament1,UI_TEXT_MOUNT_FILAMENT_SOFT,UI_ACTION_MOUNT_FILAMENT_SOFT,MENU_MODE_PRINTER, MENU_MODE_PRINTING | MENU_MODE_PAUSED)
UI_MENU_ACTIONCOMMAND_FILTER(ui_menu_extruder_mount_filament2,UI_TEXT_MOUNT_FILAMENT_HARD,UI_ACTION_MOUNT_FILAMENT_HARD,MENU_MODE_PRINTER, MENU_MODE_PRINTING | MENU_MODE_PAUSED)
...
UI_MENU_SUBMENU_FILTER(ui_submenu_extruder_mount, UI_TEXT_MOUNT_FILAMENT, ui_menu_extruder_mount, MENU_MODE_PRINTER, MENU_MODE_PRINTING | MENU_MODE_PAUSED)

UI_MENU_ACTIONCOMMAND_FILTER(ui_menu_extruder_unmount_filament1,UI_TEXT_UNMOUNT_FILAMENT_SOFT,UI_ACTION_UNMOUNT_FILAMENT_SOFT,MENU_MODE_PRINTER, MENU_MODE_PRINTING | MENU_MODE_PAUSED)
UI_MENU_ACTIONCOMMAND_FILTER(ui_menu_extruder_unmount_filament2,UI_TEXT_UNMOUNT_FILAMENT_HARD,UI_ACTION_UNMOUNT_FILAMENT_HARD,MENU_MODE_PRINTER, MENU_MODE_PRINTING | MENU_MODE_PAUSED)
...
UI_MENU_SUBMENU_FILTER(ui_submenu_extruder_unmount, UI_TEXT_UNMOUNT_FILAMENT, ui_menu_extruder_unmount, MENU_MODE_PRINTER, MENU_MODE_PRINTING | MENU_MODE_PAUSED)
...
UI_MENU_ACTIONSELECTOR_FILTER(ui_menu_quick_stop_print, UI_TEXT_STOP_PRINT, ui_menu_quick_stop_print_ack, MENU_MODE_PRINTING, MENU_MODE_MILLER)
...
UI_MENU_ACTIONSELECTOR_FILTER(ui_menu_quick_stop_mill, UI_TEXT_STOP_MILL, ui_menu_quick_stop_mill_ack, MENU_MODE_PRINTING, MENU_MODE_PRINTER)


UI_MENU_ACTIONCOMMAND_FILTER(ui_menu_quick_stopstepper,UI_TEXT_DISABLE_STEPPER,UI_ACTION_DISABLE_STEPPER,0, MENU_MODE_PRINTING | MENU_MODE_PAUSED)

UI_MENU_CHANGEACTION(ui_menu_quick_speedmultiply,UI_TEXT_SPEED_MULTIPLY,UI_ACTION_FEEDRATE_MULTIPLY)

UI_MENU_ACTIONCOMMAND_FILTER(ui_menu_quick_output_object,UI_TEXT_OUTPUT_OBJECT,UI_ACTION_RF_OUTPUT_OBJECT,0, MENU_MODE_PRINTING | MENU_MODE_PAUSED)
...
UI_MENU_ACTIONCOMMAND_FILTER(ui_menu_zero_digits_homing,UI_TEXT_DO_FEATURE_ZERO_DIGITS,UI_ACTION_FEATURE_ZERO_DIGITS,MENU_MODE_PRINTER, MENU_MODE_PRINTING | MENU_MODE_PAUSED)
...
UI_MENU_ACTIONCOMMAND_FILTER(ui_menu_digits_cmp,UI_TEXT_DO_DIGIT_COMPENSATION,UI_ACTION_DIGIT_COMPENSATION,MENU_MODE_PRINTER, MENU_MODE_PRINTING | MENU_MODE_PAUSED)
...
UI_MENU_CHANGEACTION_FILTER(ui_menu_microsteps_xy, UI_TEXT_MICRO_STEPS_XY, UI_ACTION_MICROSTEPS_XY, MENU_MODE_PRINTER, MENU_MODE_PRINTING | MENU_MODE_PAUSED)
UI_MENU_CHANGEACTION_FILTER(ui_menu_microsteps_z,  UI_TEXT_MICRO_STEPS_Z , UI_ACTION_MICROSTEPS_Z, MENU_MODE_PRINTER, MENU_MODE_PRINTING | MENU_MODE_PAUSED)
UI_MENU_CHANGEACTION_FILTER(ui_menu_microsteps_e,  UI_TEXT_MICRO_STEPS_E , UI_ACTION_MICROSTEPS_E, MENU_MODE_PRINTER, MENU_MODE_PRINTING | MENU_MODE_PAUSED)
...
UI_MENU_SUBMENU_FILTER(ui_menu_conf_pid, UI_TEXT_TEMPERATURES, ui_menu_pid, MENU_MODE_PRINTER, MENU_MODE_PRINTING | MENU_MODE_PAUSED)
...
UI_MENU_ACTIONSELECTOR_FILTER(ui_menu_restore_defaults,UI_TEXT_RESTORE_DEFAULTS,ui_menu_restore_defaults_ack, 0, MENU_MODE_PRINTING | MENU_MODE_PAUSED)
...
UI_MENU_SUBMENU_FILTER(ui_menu_main2, UI_TEXT_POSITION, ui_menu_positions, 0, MENU_MODE_PRINTING | MENU_MODE_PAUSED)
...
#define UI_MENU_MAIN {UI_MENU_ADDCONDBACK UI_MENU_QUICK_SETTINGS_ENTRY UI_MENU_POSITION_ENTRY UI_MENU_PAUSE_POSITION_ENTRY UI_MENU_EXTRUDER_ENTRY UI_MENU_FAN_COND UI_MENU_CONFIGURATION_ENTRY}
UI_MENU(ui_menu_main,UI_MENU_MAIN,UI_MENU_BACKCNT+UI_MENU_QUICK_SETTINGS_COUNT+UI_MENU_PAUSE_POSITION_COUNT+UI_MENU_POSITION_COUNT+UI_MENU_EXTRUDER_COUNT+UI_MENU_FAN_CNT+UI_MENU_CONFIGURATION_COUNT)
