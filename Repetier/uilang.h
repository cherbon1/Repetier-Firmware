...
#define UI_TEXT_ACTION_XPOSITION4       "X%hX%x0 %x3mm","Endstop min:%sx","Endstop max:%sX","%px"
#define UI_TEXT_ACTION_YPOSITION4       "Y%hY%x1 %x4mm","Endstop min:%sy","Endstop max:%sY","%py"
#define UI_TEXT_ACTION_ZPOSITION4       "Z%hZ%x2%x5 %sC","Endstop min:%sz","Endstop max:%sZ","%pz"
#define UI_TEXT_ACTION_ZOFFSET          "Z:%z0 um","","",""
#define UI_TEXT_ACTION_EPOSITION_FAST2  "E:%x6 mm","1 click = 1 mm"
...
#define UI_ACTION_TEXT_TYREUS_LYBEN_TIPP    "(choose for highpower bed)"
    ...
    #define UI_TEXT_RESTORE_DEFAULTS4       UI_TEXT_RESTORE_DEFAULTS,UI_TEXT_CONFIGURATION "?","%mYJa","%mNNein"
...
#define UI_TEXT_ACTION_ZPOSITION4       "Z%hZ%x2%x5%sC","Endstop min:%sz","Endstop max:%sZ","%pz"
#define UI_TEXT_ACTION_ZOFFSET          "Z:%z0 um","","",""
#define UI_TEXT_ACTION_EPOSITION_FAST2  "E:%x6 mm","1 klick = 1 mm"
