...
#define UI_TEXT_MOVE_ACCEL_X            "TravelX :%aX"
#define UI_TEXT_MOVE_ACCEL_Y            "TravelY :%aY"
#define UI_TEXT_MOVE_ACCEL_Z            "TravelZ :%aZ"
#define UI_TEXT_JERK                    "X/Y-Jerk:%aj"
#define UI_TEXT_ZJERK                   "Z-Jerk  :%aJ"
#define UI_TEXT_E0JERK                  "E0-Jerk :%Xh"
#define UI_TEXT_E1JERK                  "E1-Jerk :%XH"
...
#define UI_TEXT_ACTION_XPOSITION4       "X:%x0 mm %hx","Endstop min:%sx","Endstop max:%sX","%px"
#define UI_TEXT_ACTION_YPOSITION4       "Y:%x1 mm %hy","Endstop min:%sy","Endstop max:%sY","%py"
#define UI_TEXT_ACTION_ZPOSITION4       "Z:%x2 mm %sC%hz","Endstop min:%sz","Endstop max:%sZ","%pz"
#define UI_TEXT_ACTION_XPOSITION_FAST4  "X:%x0 mm %hx","Endstop min:%sx","Endstop max:%sX","%px"
#define UI_TEXT_ACTION_YPOSITION_FAST4  "Y:%x1 mm %hy","Endstop min:%sy","Endstop max:%sY","%py"
#define UI_TEXT_ACTION_ZPOSITION_FAST4  "Z:%x2 mm %sC%hz","Endstop min:%sz","Endstop max:%sZ","%pz"
...
#define UI_TEXT_PRINT_ACCEL_X           "Drucken X:%ax"
#define UI_TEXT_PRINT_ACCEL_Y           "Drucken Y:%ay"
#define UI_TEXT_PRINT_ACCEL_Z           "Drucken Z:%az"
#define UI_TEXT_PRINT_ACCEL_E0          "DruckenE0:%Xf"
#define UI_TEXT_PRINT_ACCEL_E1          "DruckenE1:%XF"
#define UI_TEXT_MOVE_ACCEL_X            "Bewegen X:%aX"
#define UI_TEXT_MOVE_ACCEL_Y            "Bewegen Y:%aY"
#define UI_TEXT_MOVE_ACCEL_Z            "Bewegen Z:%aZ"
...
#define UI_ACTION_TEXT_TYREUS_LYBEN_TIPP    "(empf. f" STR_uuml "r highpower Bett)"
	...
	#define UI_TEXT_E0JERK                  "E0-Ruck  :%Xh"
	#define UI_TEXT_E1JERK                  "E1-Ruck  :%XH"
